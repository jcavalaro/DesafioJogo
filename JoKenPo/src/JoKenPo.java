...
public class JoKenPo {
	...
	// O programa deve ser capaz de escanear a jogada/escolha do usuário e como
	// saida deve aparecer a escolha do computador
	// e seu respectivo resultado : ex: Usuário Ganhou, Computador Ganhou, empate.

	/*
	 * Nota: aqui, o desenvolvedor pode usar diferentes métodos e lógicas para
	 * chegar ao solicitado pelo exercício, Pode usar laços de repetição de diversas
	 * formas, para facilitar, podemos indicar de inicio o uso da biblioteca Randon,
	 * mas fica a critério do avaliador.
	 */

	// Abaixo um exemplo prático de construção do jogo

	public static void main(String[] args) {
		// vou montar a logica utilizando conta matemaica para obter o resultado do
		// jogo, segue a logica abaixo:

		/*
		 * Lógica: 1-Pedra / 2 - Papel / 3 - Tesoura Empate: O resultado de ambos dará 0
		 * , ou seja se o usuário colocar 1 e o computador colocar 1, o resultado será 0
		 * e assim por diante. Usuário - Computador = Resultado 1 - 2 = -1 Computador
		 * Ganhou 1 - 3 = -2 Usuário Ganhou 2 - 1 = 1 Usuário Ganhou 2 - 3 = -1
		 * Computador Ganhou 3 - 1 = 2 Computador Ganhou 3 - 2 = 1 Usuário Ganhou
		 */
	...
	public static void escolhaComputador() {
		...
		computador = randon.nextInt(3) + 1; // computador escolhe, sabemos que o computador começa a contagem a partir
											// do 0
		// então para nosso calculo dar certo, pedimos para que ele pare antes do 3 e
		// somamos +1 dessa forma o numero virá
		// de 1 a 3;
